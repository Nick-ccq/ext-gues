...
//  void DFRobot_Gesture_TouchSetTxBufferSize(int size){
//         if(size > 100) {
//             size = 100;
//         }
//         DFGT_Serial.serial.setTxBufferSize(size);
//     }

//     //%
//     void DFRobot_Gesture_TouchSetRxBufferSize(int size){
//         if(size > 100) {
//             size = 100;
//         }
//         DFGT_Serial.serial.setRxBufferSize(size);
//     }

//     //%
//     void DFRobot_Gesture_TouchEventOn(){
//         DFGT_Serial.serial.eventOn(ManagedString('\r'), MicroBitSerialMode::ASYNC);
//     }

//     //%
//     void DFRobot_Gesture_TouchClearRxBuffer(){
//         DFGT_Serial.serial.clearRxBuffer();
//     }

//     //%
//     void DFRobot_Gesture_TouchClearTxBuffer(){
//         DFGT_Serial.serial.clearTxBuffer();
//     }
...
//     //%
//     void DFRobot_Gesture_Touchforevers(Action a) {
//       if (a != 0) {
//         incr(a);
...
//     //%
//      void DFRobot_Gesture_TouchWriteString(StringData *text) {
//        if (!text) {
//            return;
//        }
//        DFGT_Serial.serial.send(ManagedString(text));
//      }
//  }
